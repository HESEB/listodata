(function(){
  ...
  const HIDE_IDS=[
    'event-calendar-link','market-memory-link','case-comparison-link','classification-review-link','rule-test-link','change-log-link',
    'event-calendar-nav','market-memory-nav','case-comparison-nav','classification-review-nav','rule-test-nav','change-log-nav'
  ];
  function addStyle(){
    if(document.getElementById('dashboard-menu-style'))return;
    const css=`
      .dss-menu-wrap{border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.78);border-radius:22px;padding:12px;margin-top:12px;box-shadow:0 10px 24px rgba(18,28,40,.06)}
      .dss-menu-head{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-bottom:8px}.dss-menu-title{font-size:14px;font-weight:820;letter-spacing:-.2px}.dss-menu-sub{font-size:11px;color:rgba(24,34,49,.66);line-height:1.4}.dss-menu-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:9px}.dss-menu-group{border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.72);border-radius:17px;padding:10px}.dss-menu-group h3{font-size:13px;margin:0}.dss-menu-desc{font-size:11px;color:rgba(24,34,49,.64);margin-top:3px}.dss-menu-links{display:flex;gap:6px;flex-wrap:wrap;margin-top:9px}.dss-menu-links a{font-size:11px;border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.82);border-radius:999px;padding:6px 8px;text-decoration:none;color:#182231}.dss-nav-menu{border:1px solid rgba(20,30,40,.09);background:linear-gradient(90deg,rgba(241,133,174,.18),rgba(107,178,255,.16));padding:8px 12px;border-radius:999px;cursor:pointer;font-size:13px;color:#182231;text-decoration:none;font-weight:760}.dss-menu-open{position:fixed;right:14px;bottom:14px;z-index:9999;border:1px solid rgba(20,30,40,.09);background:linear-gradient(90deg,rgba(241,133,174,.92),rgba(107,178,255,.92));color:#182231;border-radius:999px;padding:10px 13px;font-size:12px;font-weight:800;box-shadow:0 12px 26px rgba(18,28,40,.18);cursor:pointer}.dss-drawer{position:fixed;right:14px;bottom:60px;width:min(420px,calc(100vw - 28px));max-height:70vh;overflow:auto;z-index:9998;border:1px solid rgba(20,30,40,.12);background:rgba(255,255,255,.97);backdrop-filter:blur(10px);border-radius:22px;box-shadow:0 18px 44px rgba(18,28,40,.20);padding:13px;display:none}.dss-drawer.active{display:block}.dss-drawer h2{font-size:16px;margin:0 0 8px}.dss-drawer .dss-menu-grid{grid-template-columns:1fr}@media(max-width:720px){.dss-menu-grid{grid-template-columns:1fr}.dss-menu-open{right:10px;bottom:10px}.dss-drawer{right:10px;bottom:56px;width:calc(100vw - 20px)}}
    `;
