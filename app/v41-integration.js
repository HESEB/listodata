...
(function(){
  ...
  function statusLabel(x){return x?.data_status_label || (x?.data_status==='OFFICIAL_FETCHED'?'공식수집':'샘플/수동');}
  ...
  function addQuickLinks(){const hub=document.getElementById('sourceQuick');if(!hub||document.getElementById('v41-quick-links'))return;const box=document.createElement('div');box.id='v41-quick-links';box.className='source-card';box.innerHTML='<div class="news-meta"><span class="badge type">v4.1</span><span>숫자·점수</span></div><div class="news-title">숫자 기반 핵심지표 / 시장신호 산식</div><div class="news-desc">공식수집/샘플 여부를 구분해서 표시합니다.</div><a class="link" href="./metrics.html" target="_blank" rel="noopener">핵심지표 보기 ↗</a><br><a class="link" href="./score.html" target="_blank" rel="noopener">산식 보기 ↗</a>';
    hub.prepend(box);
  }
