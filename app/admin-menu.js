(function(){
  ...
  const ADMIN_GROUPS=[
    {title:'DSS 2.0',desc:'데이터 중심 전환',items:[
      ...
      ['KOSIS 후보 품질점수','./kosis-candidate-quality.html','첫 실행 후보 점수·우선 검수 대상'],
    ...
    {title:'검수',desc:'분류 결과와 제외 자료 검토',items:[
      ...
      ['KOSIS 후보 품질점수','./kosis-candidate-quality.html','P1·P2 우선 검수 후보 확인'],
      ['KOSIS 수집 검증','./kosis-operational-collection-validation.html','운영 수집 성공 표본과 Secret 폐기 승인 검수'],
  ...
  function addOperationsBadges(){if(document.getElementById('operations-badges-script'))return;const s=document.createElement('script');s.id='operations-badges-script';s.src='./operations-badges.js?v=phase-10-3';s.defer=true;document.body.appendChild(s);}
