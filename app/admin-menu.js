(function(){
  ...
  function addStyle(){
    ...
    const css=`
      .admin-menu-wrap{border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.80);border-radius:22px;padding:12px;margin:12px 0;box-shadow:0 10px 24px rgba(18,28,40,.06)}.admin-menu-head{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-bottom:9px}.admin-menu-title{font-size:15px;font-weight:830;letter-spacing:-.3px}.admin-menu-sub{font-size:11px;color:rgba(24,34,49,.66);line-height:1.4}.admin-menu-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:9px}.admin-menu-group{border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.72);border-radius:17px;padding:10px}.admin-menu-group h3{font-size:13px;margin:0}.admin-menu-desc{font-size:11px;color:rgba(24,34,49,.64);margin-top:3px}.admin-menu-links{display:flex;gap:6px;flex-wrap:wrap;margin-top:9px}.admin-menu-links a{font-size:11px;border:1px solid rgba(20,30,40,.09);background:rgba(255,255,255,.82);border-radius:999px;padding:6px 8px;text-decoration:none;color:#182231}.admin-menu-open{position:fixed;right:14px;bottom:14px;z-index:9999;border:1px solid rgba(20,30,40,.09);background:linear-gradient(90deg,rgba(241,133,174,.92),rgba(107,178,255,.92));color:#182231;border-radius:999px;padding:10px 13px;font-size:12px;font-weight:800;box-shadow:0 12px 26px rgba(18,28,40,.18);cursor:pointer}.admin-drawer{position:fixed;right:14px;bottom:60px;width:min(440px,calc(100vw - 28px));max-height:70vh;overflow:auto;z-index:9998;border:1px solid rgba(20,30,40,.12);background:rgba(255,255,255,.97);backdrop-filter:blur(10px);border-radius:22px;box-shadow:0 18px 44px rgba(18,28,40,.20);padding:13px;display:none}.admin-drawer.active{display:block}.admin-drawer h2{font-size:16px;margin:0 0 8px}.admin-drawer .admin-menu-grid{grid-template-columns:1fr}.admin-hidden-link{display:none!important}@media(max-width:720px){.admin-menu-grid{grid-template-columns:1fr}.admin-menu-open{right:10px;bottom:10px}.admin-drawer{right:10px;bottom:56px;width:calc(100vw - 20px)}}
    `;
